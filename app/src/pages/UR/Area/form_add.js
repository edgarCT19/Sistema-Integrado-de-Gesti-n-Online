        ...
        <div className="card">
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        required
                        label="Nombre o nomenclatura del área"
                        variant="outlined"
                        fullWidth
                    />
                </Grid>
                <Grid item xs={12} sm={6}>
                 <FormControl fullWidth>
                   <InputLabel>Selecciona el Edificio</InputLabel>
                   <Select label="Selecciona el Edificio" defaultValue="">
                    ...
                    <MenuItem value="Laboratorio Pesado">Laboratorio Pesado</MenuItem>
                   </Select>
                 </FormControl>
                </Grid>
                <Grid item xs={12} sm={6}>
                   <TextField 
                    required
                    label="Nombre del encargado (a) del área"
                    type="text"
                    variant="outlined"
                    fullWidth
                   />

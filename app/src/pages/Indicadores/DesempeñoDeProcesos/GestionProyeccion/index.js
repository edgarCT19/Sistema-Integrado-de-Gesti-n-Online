    ...
    return(
        <div className="right-content">
            <div className="indicator-section-title justify-content-center d-flex">
                Indicador Gestión Proyección del 10%
            </div>
            <div className="mt-2">
                <div className="card">
                                ...
                                <tbody>
                                    {data.map((row, index) => (
                                        <tr key={row.aspecto} className={index % 2 === 0 ? "" : ""}>
                                            ...
                                            <td>{row.fecha2}</td>
                                            <td>{row.valor1}</td>
                                            <td style={{background:"var(--color-uacam-secondary)"}}>{row.valor2}</td>
                                            <td style={{background:"var(--color-uacam-secondary)"}}>{row.meta}</td>
                                            <td>
...
export default Gestion_proyeccion;
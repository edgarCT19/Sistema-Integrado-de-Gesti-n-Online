...
const bitacora_rsume_acopio = () => {

    return (
        <div className="w-100 right-content">
            <div className="card">
            <center><h5>CENTRO DE ACOPIO - RME </h5></center>
                    ...
                    <div className="table-container">
                        <table className="styled-table text-center">
                            <thead>
                                ...
                                <th className="table-title text-center" >Dependencia</th>
...
export default bitacora_rsume_acopio;

...
const bitacora_rsume_reuso = () => {

    return (
        <div className="w-100 right-content">
            <div className="card">
            <center><h5>CENTRO DE ACOPIO RESIDUOS PARA REUSO Y/O RECICLAJE </h5></center>
                    ...
                    <div className="table-container">
                        <table className="styled-table text-center">
                            <thead>
                                ...
                                <th className="table-title text-center" >Dependencia o Area</th>
                                <th className="table-title text-center" >PET</th>
                                <th className="table-title text-center" >Papel</th>
                                <th className="table-title text-center" >Carton</th>
                                <th className="table-title text-center" >Metales</th>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-sm">PET</span>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                            </div>
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-sm">PAPEL</span>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                            </div>
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-sm">CARTON</span>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                            </div>
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-sm">METALES</span>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                            </div>
                            <br></br>
                            </div>
...
export default bitacora_rsume_reuso;
